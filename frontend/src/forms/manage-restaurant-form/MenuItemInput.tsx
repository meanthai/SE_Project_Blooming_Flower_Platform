        ...
        <div className="flex flex-row items-end gap-2">
            <FormField control={control} name={`menuItems.${index}.name`} render={({ field }) => (
                    <FormItem>
                        ...
                        <FormControl>
                            <Input {...field} placeholder="Sushi" className="bg-white, w-100"/>
                        </FormControl>
                    </FormItem>
                )}
            />
            ...
            <FormField control={control} name={`menuItems.${index}.description`} render={({ field }) => (
                    <FormItem>
                        <FormLabel className="flex items-center gap-1">
                        ...
                        <FormControl>
                            <Input {...field} placeholder="this dish is amazing" className="bg-white w-64"/>
                        </FormControl>
                    </FormItem>
                )}
            />
